# -*- coding:utf-8 _*-
# @license: Modifoed from @author: chkarada
# @Author: Forence
...
def write_frames(frames, filename, channels, sample_rate, record_width):  # TODO: has not been tested
...
def audio_segmenter_4_file(input_path, dest_dir, segment_len, stepsize, fs=None, window='hann', padding=False,
						   pow_2=False, save2segFolders=False):  # TODO: has not been tested
	'''
...
def audio_segmenter_4_numpy(audio, segment_len, stepsize, fs=16000, window='hann', padding=False,
							pow_2=False):  # TODO: has not been tested
	'''
...
def rolling_window(a, window, step=1):  # TODO: has not been tested
...
def save_wav(filepath, sample_rate, audio_string):  # TODO: has not been tested
...
def save_multi_channel_audio(audio, fs, des_dir, norm=False, ):  # TODO: has not been tested
...
def normalize_single_channel_audio(audio, rms=None, target_level=-25, returnScalar=False):  # TODO: has not been tested
...
def normalize_segmental_rms(audio, rms, target_level=-25):  # TODO: has not been tested
...
def add_reverb(sasxExe, input_wav, filter_file, output_wav):  # TODO: has not been tested
...
def add_clipping(audio, max_thresh_perc=0.8):  # TODO: has not been tested
...
def adsp_filter(Adspvqe, nearEndInput, nearEndOutput, farEndInput):  # TODO: has not been tested
...
def snr_mixer(params, clean, noise, snr, target_level=-25, clipping_threshold=0.99):  # TODO: has not been tested
...
def segmental_snr_mixer(params, clean, noise, snr, target_level=-25,
						clipping_threshold=0.99):  # TODO: has not been tested
...
def is_clipped(audio, clipping_threshold=0.99):  # TODO: has not been tested
	return any(abs(audio) > clipping_threshold)


def active_rms(clean, noise, fs=16000, energy_thresh=-50, window_size=32):  # TODO: has not been tested
...
def active_rms_percentage(clean, noise, fs=16000, active_percentage=0.2, window_size=32):  # TODO: has not been tested
...
def audio_energy_ratio_over_threshold(audio, fs=16000, threshold=None, ):  # TODO: has not been tested
...
def audio_energy_over_threshold(audio, threshold=None):  # TODO: has not been tested
	energy_mean = (audio ** 2).sum() / len(audio)
	# print('energy', threshold, energy_mean)
	return energy_mean > threshold


def single_side_fft(audio, fs):  # TODO: has not been tested
	# rfft_amp = np.abs(rfft(audio))
	# return rfft_amp
	return np.abs(rfft(audio)) / fs * 2


def magspec(frames, NFFT):  # TODO: has not been tested
...
def powspec(frames, NFFT):  # TODO: has not been tested
...
def logpowspec(frames, NFFT, norm=1):  # TODO: has not been tested
...
def preemphasis(signal, coeff=0.95):  # TODO: has not been tested
