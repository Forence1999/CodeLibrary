...
def compute_gradient(x, model, target):  # TODO: has not been tested
	"""
...
def eva_model(model, dataset):  # TODO: has not been tested
	'''
...
def calculate_weighted_acc(x, y, model, class_weight):  # TODO: has not been tested
...
class weighted_acc_callback(Callback):  # TODO: has not been tested
...
class customized_earlystopping(EarlyStopping):  # TODO: has not been tested
...
class customized_modelcheckpoint(ModelCheckpoint):  # TODO: has not been tested
...
def set_gpu_memory_growth(growth):  # TODO: has not been tested
...
def _compute_preds_loss_grad(model, x, y):  # TODO: has not been tested
	"""
...
def train_base(model_fn, dataset, epochs=300, batchsize=32, lr=1e-3, model_name=None,
			   device=None):  # TODO: has not been tested
	"""
...
def evaluate_model(model_fn, dataset_name, batchsize=128, model_name=None, device=None):  # TODO: has not been tested
	"""
...
def train_classical_model(model_fn, dataset_name, model_name=None, evaluate=True):  # TODO: has not been tested
	"""
	Trains the base classifier (aka the attacked classifier).
...
def evaluate_classical_model(model_fn, dataset_name, model_name=None):  # TODO: has not been tested
	"""
	Trains the base classifier (aka the attacked classifier).
...
class BaseClassicalModel(object):  # TODO: has not been tested
...
def to_categorical(y, num_classes=None, dtype='float32'):  # TODO: has not been tested
...
def reranking(y, target, alpha):  # TODO: has not been tested
	"""
...
def rescaled_softmax(y, num_classes, tau=1.):  # TODO: has not been tested
	"""
...
def target_accuracy(y_label, y_pred, target):  # TODO: has not been tested
	"""
...
def split_dataset(x_test, y_test, test_fraction=0.5):  # TODO: has not been tested
	"""
...
def load_dataset(dataset_name='mnist'):  # TODO: has not been tested
	"""
...
def load_image_dataset(dataset_name='mnist'):  # TODO: has not been tested
	"""
...
def prepare_dataset(X_train, y_train, X_test, y_test, batch_size, shuffle=True,
					device=None):  # TODO: has not been tested
	"""
...
def plot_image_adversary(sequence, title, ax, remove_axisgrid=False,
						 ...
						 imlabel=None, color=None, alpha=1.0):  # TODO: has not been tested
	"""
