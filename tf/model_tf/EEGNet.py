...
def EEGNet(num_classes, Chans=64, SamplePoints=128, dropoutRate=None, kernLength=128, F1=4, D=2, F2=8,
		   dropoutType='Dropout'):
	...
	block1 = Conv2D(F1, (1, kernLength), padding='same', input_shape=(1, Chans, SamplePoints), use_bias=False)(input1)
	...
	dense = Dense(num_classes, name='dense', kernel_constraint=max_norm(0.25))(flatten)
